...
const Menu = () => {
  ...
  function openModal() {
    dispatch(
      createOrder({
        productId: data[productIndex]._id,
        price: data[productIndex].price,
        amount: data[productIndex].price * quantity,
      })
    );
    setIsOpen(true);
  }
        ...
        <div className="menu-container" id="menu">
          ...
          >
            ...
            <p className="modal-title">
              Bạn đã đặt thành công {quantity} suất ăn!
            </p>
            <p className="modal-subtitle">
              Hãy chuyển khoản {quantity * data[productIndex]?.price}đ bằng cách
              quét mã QR để thanh toán đặt hàng
            </p>
            <div>
