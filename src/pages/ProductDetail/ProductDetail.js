  ...
  return (
    <div className='product-detail-wrapper'>
      <div className='product-detail-container' id="container">
          <div className='product-detail-main'>
            <div className='product-detail-left'>
              <img src={productData?.image !== undefined ? `data:image/png;base64, ${Buffer.from(productData?.image.data).toString('base64')}` : null} alt="" className='product-detail-image'/>
            </div>
            ...
            <div className='product-detail-rating'>
              ...
              <div className='product-detail-sell'>
                ...
                <div className='product-detail-btns'>
                  ...
                  <div className='btn btn-transparent' onClick={addToCart}>Đặt hàng</div>
                </div>
              </div>
          </div>
      </div>
      <div className='modal' id='modal'>
        ...
        <button className='btn btn-transparent modal-btn' onClick={hideModal}>OK</button>
      </div>
    </div>
  )
}
