        ...
        <div>
            {
                    ...
                    <div className='blogs__management-container'>
                        <div className='blogs_management-header'>
                            <div className='blogs_management-filters'>
                                <TextField label="Search Blog..." variant="outlined" size="small" value={searchingName} onChange={(e) => setSearchingName(e.target.value)} fullWidth />
                                <Box sx={{ width: 140 }}>
                            ...
                            <Button variant="contained" onClick={onCreateBlog}>Create Blog</Button>
                        </div>
                        {
                            !blogs?.length ?
                                ...
                                <>
                                    <div className='blogs__management-list'>
                                        {blogs?.map(blog => <Blog blog={blog} updatingBlog={setIsViewingBlogs} updatingBlogContent={setUpdatingBlogContent} />)}
                                    </div>
                ...
                :
                (
                    <CreateBlogForm cancelCreatingBlog={setIsViewingBlogs} cleanForm={setUpdatingBlogContent} updatingBlogContent={updatingBlogContent}/>
                )
            }
        </div>
  )
