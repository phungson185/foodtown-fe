...
const CreateBlogForm = ({cancelCreatingBlog, cleanForm, updatingBlogContent}) => {
    ...
    return (
        <div className='blog__create-form'>
            <TextField label="Blog Name" variant="outlined" name="name" onChange={onModifyBlogContent} value={blogInfo.name}/>
            <TextField label="Blog Description" variant="outlined" name="description" onChange={onModifyBlogContent} value={blogInfo.description}/>
            <CKEditor
                name="content"
            ...
            <div className='blog__create-buttons'>
                <Button variant="outlined" onClick={onCancelCreatingBlog}>CANCEL</Button>
                <Button variant="contained" onClick={updatingBlogContent.content ? onSubmitUpdatingBlog : onSubmitCreatingBlog}>{blogContent ? "UPDATE" : "CREATE"}</Button>
            </div>
        </div>
  )
}
